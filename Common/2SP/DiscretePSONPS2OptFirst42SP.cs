...
{
	public class DiscretePSONPS2OptFirst42SP : DiscretePSO
	{
		public TwoSPInstance Instance { get; protected set; }

        public DiscretePSONPS2OptFirst42SP(TwoSPInstance instance, int partsCount, double prevConf,
		...
		{
			TwoSPUtils.NPSLocalSearch2OptFirst(Instance, solution);
		}
	}
}
