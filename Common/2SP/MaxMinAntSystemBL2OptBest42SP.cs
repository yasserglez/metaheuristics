...
{
	public class MaxMinAntSystemBL2OptBest42SP : MaxMinAntSystem
	{
		public TwoSPInstance Instance { get; protected set; }
		
		public MaxMinAntSystemBL2OptBest42SP(TwoSPInstance instance, int numberAnts, double rho, double alpha, double beta, int maxReinit)
