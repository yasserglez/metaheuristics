...
{
	public class DiscreteSSBL2OptFirst42SP : DiscreteSS
	{
		public TwoSPInstance Instance { get; protected set; }
		
		protected int generatedSolutions;		
		
		public DiscreteSSBL2OptFirst42SP(TwoSPInstance instance, int poolSize, int refSetSize, double explorationFactor)
