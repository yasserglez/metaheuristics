...
{
	public class MaxMinAntSystem4QAP : MaxMinAntSystem
	{
		public QAPInstance Instance { get; protected set; }
		
		public MaxMinAntSystem4QAP(QAPInstance instance, int numberAnts, double rho, double alpha, double beta, int maxReinit)
