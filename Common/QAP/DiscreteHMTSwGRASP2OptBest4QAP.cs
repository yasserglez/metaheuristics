...
{
	public class DiscreteHMTSwGRASP2OptBest4QAP : DiscreteTS
	{
		...
		public DiscreteHMTSwGRASP2OptBest4QAP(QAPInstance instance, double rclThreshold, int graspIterations, int tabuListLength, int neighborChecks) 
