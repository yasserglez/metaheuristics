...
{
	public class DiscreteUMDA2OptBest4QAP : DiscreteUMDA
	{
		public QAPInstance Instance { get; protected set; }
		
		public DiscreteUMDA2OptBest4QAP(QAPInstance instance, int popSize, double truncFactor, int[] lowerBounds, int[] upperBounds)
