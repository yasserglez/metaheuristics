...
{
	public class DiscreteSS2OptFirst4SPP : DiscreteSS
	{
		public SPPInstance Instance { get; protected set; }
		
		public DiscreteSS2OptFirst4SPP(SPPInstance instance, int poolSize, int refSetSize, double explorationFactor)
