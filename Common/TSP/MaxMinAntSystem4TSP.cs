...
namespace Metaheuristics
{
	public class MaxMinAntSystem4TSP : MaxMinAntSystem
	{
		...
		public MaxMinAntSystem4TSP(TSPInstance instance, int numberAnts, double beta, int maxReinit, int candidateLength, double candidateWeight)
			: base(instance.NumberCities, TSPUtils.Fitness(instance, TSPUtils.RandomSolution(instance)),
			       numberAnts, 0.02, 1, beta, maxReinit)
		{
			Instance = instance;
