...
{
	public class SS2OptFirst4SPP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteSS ss = new DiscreteSS2OptFirst4SPP(instance, poolSize, refSetSize, explorationFactor);
		...
		public string Name {
			get {
				return "SS with 2-opt (first improvement) local search for SPP";
			}
		}
