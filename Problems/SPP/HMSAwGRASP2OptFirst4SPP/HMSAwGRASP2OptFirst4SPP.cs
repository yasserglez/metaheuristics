...
{
	public class HMSAwGRASP2OptFirst4SPP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteHMSAwGRASP2OptFirst4SPP hm = new DiscreteHMSAwGRASP2OptFirst4SPP(instance, rclTreshold, graspIterations, initialSolutions, levelLength, tempReduction);
		...
		public string Name {
			get {
				return "SA with GRASP with 2-opt (first improvement) local search for SPP";
			}
		}
