...
{
	public class ILS2OptBest4SPP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start (string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteILS ils = new DiscreteILS2OptBest4SPP(instance, restartIterations, perturbations, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "ILS with 2-opt (best improvement) local search for SPP";
			}
		}
