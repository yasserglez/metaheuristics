...
{
	public class MA4SPP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteMA memetic = new DiscreteMA4SPP(instance, (int)popSize, mutProbability, lowerBounds, upperBounds);
