...
{
	public class SSBL2OptFirst42SP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteSS ss = new DiscreteSSBL2OptFirst42SP(instance, poolSize, refSetSize, explorationFactor);
		...
		public string Name {
			get {
				return "SS using the BL heuristic with 2-opt (first improvement) local search for 2SP";
			}
		}
