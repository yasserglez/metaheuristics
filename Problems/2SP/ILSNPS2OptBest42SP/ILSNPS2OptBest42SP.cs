...
{
	public class ILSBL2OptBestt42SP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public string Name {
			get {
				return "ILS using the BL heuristic with 2-opt (best improvement) local search for 2SP";
			}
		}
