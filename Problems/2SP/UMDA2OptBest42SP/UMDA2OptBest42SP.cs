...
{
	public static class UMDA2OptBest42SP
	{
		public static string Algoritmo = "UMDA using the NPS heuristic with 2-opt (best improvement) local search for 2SP";
		...
		public static List<double> Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteUMDA umda = new DiscreteUMDA2OptBest42SP(instance, popSize, truncFactor, lowerBounds, upperBounds);
