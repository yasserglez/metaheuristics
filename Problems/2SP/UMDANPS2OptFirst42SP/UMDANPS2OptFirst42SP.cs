...
{
	public class UMDANPS2OptFirst42SP : IMetaheuristic
	{
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteUMDA umda = new DiscreteUMDANPS2OptFirst42SP(instance, popSize, truncFactor, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "UMDA using the NPS heuristic with 2-opt (first improvement) local search for 2SP";
			}
		}
