...
namespace Metaheuristics
{
	public class PSO2OptFirst42SP : IMetaheuristic
	{
        public void Start(string fileInput, string fileOutput, int timeLimit)
        {
            ...
            DiscretePSO pso = new DiscretePSONPS2OptFirst42SP(instance, particlesCount, prevConf, neighConf, lowerBounds, upperBounds);
        ...
        public string Name {
        	get {
        		return "PSO using the NPS heuristic with 2-opt (first improvement) local search for 2SP";
        	}
        }
