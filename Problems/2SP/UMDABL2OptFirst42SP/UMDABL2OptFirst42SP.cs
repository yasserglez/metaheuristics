...
namespace Metaheuristics
{
	public class UMDABL2OptFirst42SP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteUMDA umda = new DiscreteUMDABL2OptFirst42SP(instance, popSize, truncFactor, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "UMDA using the BL heuristic with 2-opt (first improvement) local search for 2SP";
			}
		}
