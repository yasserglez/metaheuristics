...
{
	public class GANPS2OptBest42SP : IMetaheuristic
	{	
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteGA genetic = new DiscreteGANPS2OptBest42SP(instance, popSize, mutProbability, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "GA using the NPS heuristic with 2-opt (best improvement) local search for 2SP";
			}
		}
