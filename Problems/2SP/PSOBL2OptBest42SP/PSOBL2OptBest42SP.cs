...
{
    public class PSOBL2OptBest42SP : IMetaheuristic, ITunableMetaheuristic
    {
        ...
        public void Start(string fileInput, string fileOutput, int timeLimit)
        {
            ...
            DiscretePSO pso = new DiscretePSOBL2OptBest42SP(instance, particlesCount, prevConf, neighConf, lowerBounds, upperBounds);
        ...
        public string Name {
        	get {
        		return "PSO using the BL heuristic with 2-opt (best improvement) local searcg for 2SP";
        	}
        }
