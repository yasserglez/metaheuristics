...
namespace Metaheuristics
{
	public class HMTSwGRASP2OptFirst4QAP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteHMTSwGRASP2OptFirst4QAP hm = new DiscreteHMTSwGRASP2OptFirst4QAP(instance, rclTreshold, graspIterations, tabuListLength, neighborChecks);
		...
		public string Name {
			get {
				return "TS with GRASP with 2-opt (first improvement) local search for QAP";
			}
		}
