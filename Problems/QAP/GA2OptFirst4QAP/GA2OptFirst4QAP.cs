...
{
	public static class GA2OptFirst4QAP
	{
		public static string Algoritmo = "GA with 2-opt (first improvement) local search for QAP";
		...
		public static List<double> Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteGA genetic = new DiscreteGA2OptFirst4QAP(instance, popSize, mutProbability, lowerBounds, upperBounds);
