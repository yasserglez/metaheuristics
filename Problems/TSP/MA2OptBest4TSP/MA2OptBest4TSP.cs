...
{
	public class MA2OptBest4TSP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteMA memetic = new DiscreteMA2OptBest4TSP(instance, (int)popSize, mutProbability, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "MA with 2-opt (best improvement) local search for TSP";
			}
		}
