...
{
	public class HMTSwGRASP2OptBest4TSP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string inputFile, string outputFile, int timeLimit)
		{
			...
			DiscreteHMTSwGRASP2OptBest4TSP hm = new DiscreteHMTSwGRASP2OptBest4TSP(instance, rclTreshold, graspIterations, tabuListLength, neighborChecks);
		...
		public string Name {
			get {
				return "TS with GRASP with 2-opt (best improvement) local search for TSP";
			}
		}
