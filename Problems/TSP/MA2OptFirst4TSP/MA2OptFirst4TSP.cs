...
{
	public class MA2OptFirst4TSP : IMetaheuristic, ITunableMetaheuristic
	{
		...
		public void Start(string fileInput, string fileOutput, int timeLimit)
		{
			...
			DiscreteMA memetic = new DiscreteMA2OptFirst4TSP(instance, (int)popSize, mutProbability, lowerBounds, upperBounds);
		...
		public string Name {
			get {
				return "MA with 2-opt (first improvement) local search for TSP";
			}
		}
